<div class="content-card">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; flex-wrap: wrap; gap: 12px;">
        <div style="min-width: 0; flex: 1;">
            ...
            <p style="color: var(--text-muted); font-size: 13.5px;">Modul <strong>Profile</strong> berhasil dibuat dan mewarisi <code>App\Http\Controllers\Core\ProfileControllers</code>.</p>
        </div>
    </div>
